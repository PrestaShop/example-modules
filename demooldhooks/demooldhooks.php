...
class DemoOldHooks extends Module
{
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('DemoOldHooks', [], 'Modules.DemoOldHooks.Config');
        $this->description = $this->trans('DemoOldHooks module description', [], 'Modules.DemoOldHooks.Config');
    }
    ...
    public function buildForm($fieldName)
    {
      ...
      $template = '@Modules/demooldhooks/views/templates/field.html.twig';
